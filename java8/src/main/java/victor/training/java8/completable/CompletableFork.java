...
public class CompletableFork {
	...
	public static void main(String[] args) throws Exception {
		...
		CompletableFuture<Void> asyncA = CompletableFuture.runAsync(CompletableFork::doExpensiveStepA);
		CompletableFuture<Void> asyncB = CompletableFuture.runAsync(CompletableFork::doExpensiveStepB);
		
		CompletableFuture.allOf(asyncA, asyncB)
			.thenRunAsync(CompletableFork::expensiveStepC)
