package victor.training.spring.webapp.servlet;
...
import victor.training.spring.webapp.UserServiceSingleton;
...
public class LoginController {
	...
	private void loginUser() {
		...
		appCtx.getBean(UserServiceSingleton.class).loginUser(request.getParameter("username"));
	}
